...
{ 
 ...
 initgraph(&gd, &gm, NULL);
    ...
    int choice;
    float radian;
    printf("\nEnter the number of edges to draw a House: ");
    scanf("%d", &edges);
...
do
{
     printf("\nSelection the Transformation you want to apply ==> \n1. Translate\n2. Rotate\n3. Scale\n4. Reflection\n5. Shear\n6. Exit\nEnter your choice ==>");
    scanf("%d", &choice);
...
radian = angle;
    ...
    case 5:
        int shx,shy;
        setcolor(MAGENTA);
        printf("\nEnter the shearing factor Shx and Shy =>");
        scanf("%d %d", &shx, &shy);
    ...
    printf("\nPress 1 to continue the Transformation => ");
    scanf("%d", &conti);
